...
private extension NSParagraphStyle {
    ...
    func inset(by amount: CGFloat) -> NSParagraphStyle {
        ...
        // HaxPick patch: upstream hard-coded `tailIndent = -amount`, which let
        // code text run past the right edge of the drawn block background.
        // Inset from the trailing margin instead.
